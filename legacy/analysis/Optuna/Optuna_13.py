...
def generate_preset_equity_curve(ticker: str, start_date: str, end_date: str, preset_params: Dict) -> Optional[pd.Series]:
    """
    ...
    try:
        ...
        if strategy_type == 'ssma_turn':
            ...
            df_ind, buy_dates, sell_dates = compute_ssma_turn_combined(
                df_price, df_factor, **ssma_params, smaa_source=smaa_source
            )
            if df_ind.empty:
            ...
            if strategy_type == 'single':
                df_ind = compute_single(
                    ...
                    preset_params['smaalen'], preset_params['devwin'], smaa_source=smaa_source
                )
